...
import es.joseluisgs.dam.io.MeteoReader;
import es.joseluisgs.dam.model.RegistroDatos;
import es.joseluisgs.dam.model.TemperaturaHora;
import es.joseluisgs.dam.service.ServicioClimatologia;
import es.joseluisgs.dam.util.PrintUtil;
    ...
    public static void main(String[] args) {
        ...
        if (args.length >= 2 && (args.length % 2 == 0)) {
            ...
            pares.stream().forEach(pair -> {
                ...
                Path path = Paths.get(WORKING_DIRECTORY + File.separator + pair[1]);
